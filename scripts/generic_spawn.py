...
'''will spawn dexter at origin in Gazebo, requires gazebo installed to run'''

def main():
    # Get input arguments from user
    parser = argparse.ArgumentParser(description='Spawn a robot into the Gazebo empty world')
